...
// IMPORTANT: This function MUST be named "onEdit" (not "onEditHandler")
// to work as a simple trigger without needing installable triggers
function onEdit(e) {
  // ---------- CONFIGURATION ----------
